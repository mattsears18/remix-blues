...
[![CodeScene System Mastery](https://codescene.io/projects/26182/status-badges/system-mastery)](https://codescene.io/projects/26182)
...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly create remix-blues-a27a
  fly create remix-blues-a27a-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-blues-a27a
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-blues-a27a-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'remix-blues-a27a-staging' does not match app name in config file 'remix-blues-a27a'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name remix-blues-a27a-db
  fly postgres attach --postgres-app remix-blues-a27a-db --app remix-blues-a27a

  fly postgres create --name remix-blues-a27a-staging-db
  fly postgres attach --postgres-app remix-blues-a27a-staging-db --app remix-blues-a27a-staging
  ```
